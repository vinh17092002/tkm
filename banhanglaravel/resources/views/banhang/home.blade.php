				...
				<div class="row">
					<div class="col-sm-12">
						<div class="beta-products-list">
								...
								<div class="col-sm-3">
									...
									@endif
										<div class="single-item-header">
											<a href="{{route('chitietsanpham',$sale->id)}}"><img src="/source/image/product/{{$sale->image}}"></a>
										</div>
										...
										<div class="single-item-caption">
											...
											<a class="beta-btn primary" href="{{route('chitietsanpham',$sale->id)}}">Thông tin<i class="fa fa-chevron-right"></i></a>
											<div class="clearfix"></div>
										</div>
									</div>
								</div>
							...
							<div style="text-align:center">{{$sale_products->links()}}</div>
						...
						<div class="beta-products-list">
							<h4>Sản phẩm mới</h4>
							<div class="beta-products-details">
								<p class="pull-left">Tìm thấy{{($new_products->total())}} sản phẩm</p>
								<div class="clearfix"></div>
							</div>
							<div class="row">
						...
						@endforeach
							...
							<div style="text-align:center">{{$new_products->links()}}</div>
						</div> <!-- .beta-products-list -->
					</div>
